            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="border-t pt-4">
                  ...
                  <p
                    className={`text-2xl font-bold ${financialData.summary?.net_profit >= 0 ? "text-green-600" : "text-red-600"}`}
                  >
                    ₹{financialData.summary?.net_profit.toLocaleString("en-IN")}
                  </p>
                  <p className="text-gray-500 text-xs mt-2">
                    Profit Margin:{" "}
                    {financialData.summary?.profit_margin_percent}%
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="text-center p-4 bg-green-50 rounded">
                ...
                <p className="text-2xl font-bold text-green-600">
                  {dashboardData?.operations.inventory
                    ? (dashboardData.operations.inventory as any).all_stocks
                        ?.length -
                      (dashboardData.operations.inventory as any).critical_count
                    : 0}
                </p>
              </div>
              <div className="text-center p-4 bg-yellow-50 rounded">
                ...
                <p className="text-2xl font-bold text-yellow-600">
                  {(dashboardData?.operations.inventory as any)?.low_stock_items
                    ?.length || 0}
                </p>
              </div>
              <div className="text-center p-4 bg-red-50 rounded">
                ...
                <p className="text-2xl font-bold text-red-600">
                  {(dashboardData?.operations.inventory as any)
