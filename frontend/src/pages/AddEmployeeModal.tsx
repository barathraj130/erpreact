...
const AddEmployeeModal: React.FC<Props> = ({
  ...
  useEffect(() => {
    if (employeeToEdit) {
      ...
      setJoiningDate(
        employeeToEdit.joining_date
          ? employeeToEdit.joining_date.substring(0, 10)
          : "",
      );
      ...
      if (employeeToEdit.signature_url) {
        setSignaturePreview(
          `http://localhost:3000${employeeToEdit.signature_url}`,
        );
      }
    }
  }, [employeeToEdit]);
          ...
          <form id="employee-form" onSubmit={handleSubmit}>
            ...
            <div style={{ marginBottom: "15px" }}>
              ...
              <div style={{ position: "relative" }}>
                ...
                <input
                  ...
                  style={inputStyle}
                  placeholder="Manager, Labour, etc."
                />
              </div>
            </div>
            ...
            >
              ...
              <div>
                ...
                >
                  {salaryType === "Monthly" &&
                    "Fixed monthly salary paid at end of month"}
                  {salaryType === "Weekly" &&
                    "Weekly payment based on 6-day work week"}
