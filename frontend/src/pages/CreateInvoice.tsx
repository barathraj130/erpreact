...
const CreateInvoice: React.FC = () => {
  ...
  const [invoiceNo, setInvoiceNo] = useState(""); // kept only for print preview display
  const [nextInvoiceNo, setNextInvoiceNo] = useState<string>(""); // auto-preview from backend
  ...
  const saveInvoice = async () => {
    ...
    try {
      const body = {
        // invoice_number intentionally omitted — always auto-generated by backend
