        ...
        <div className="reports-page">
            ...
            <div className="reports-grid">
                ...
                <div className="report-card" style={{ gridColumn: 'span 4' }}>
                   <div className="report-card-title"><FaCheckCircle color="#10b981" /> Fulfillment Ratio (R2)</div>
                ...
                <div className="report-card" style={{ gridColumn: 'span 4' }}>
                    <div className="report-card-title"><FaBoxes color="#3b82f6" /> Inventory Movement (R1)</div>
                    <div style={{ marginTop: '20px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', color: '#64748b', marginBottom: '8px' }}>
                            <span>Total Inflow</span>
                            <span style={{ fontWeight: 700, color: '#1e293b' }}>{procurement.inventory?.in || 0} Units</span>
                        </div>
                    ...
                    <div style={{ marginTop: '16px' }}>
                        <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: '12px', color: '#64748b', marginBottom: '8px' }}>
                            ...
                            <span style={{ fontWeight: 700, color: '#ef4444' }}>{procurement.inventory?.out || 0} Units</span>
                        </div>
                        <div style={{ height: '6px', width: '100%', background: '#f1f5f9', borderRadius: '10px', overflow: 'hidden' }}>
                            <div style={{ height: '100%', width: `${((procurement.inventory?.out || 0) / (procurement.inventory?.in || 1)) * 100}%`, background: '#ef4444' }} />
                        </div>
                    </div>
                    <p style={{ fontSize: '11px', color: '#94a3b8', marginTop: '12px' }}>Net Stock Rotation: {Math.round(((procurement.inventory?.out || 0) / (procurement.inventory?.in || 1)) * 100)}%</p>
                </div>
                ...
                <div className="report-card" style={{ gridColumn: 'span 12' }}>
                    <div className="report-card-title"><FaUsers /> Strategic Supplier Performance (R2 Details)</div>
                                ...
                                <tr key={s.name}>
                                    ...
                                    <td>
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                                            <div style={{ flex: 1, height: '4px', background: '#f1f1f0', borderRadius: '2px', width: '60px' }}>
                                                <div style={{ height: '100%', width: `${s.success_rate}%`, background: s.success_rate > 80 ? '#10b981' : '#f59e0b', borderRadius: '2px' }} />
                                            </div>
                                            <span style={{ fontWeight: 700, fontSize: '12px' }}>{s.success_rate}%</span>
                                        </div>
                                    </td>
                                    <td>
                                        <span className={`badge-glow ${s.success_rate > 90 ? 'bg-success-glow' : 'bg-warning-glow'}`}>
