  ...
  const handleCreateBill = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        alert("Failed to save bill: " + (err.error || "Unknown error"));
      }
    } catch (err) {
        ...
        {viewBill && (
          ...
          >
            ...
            >
              <div className="modal-header">
                <div>
                  <h3 style={{ margin: 0, fontWeight: 700 }}>Bill Details</h3>
                  <p style={{ margin: 0, fontSize: "0.8rem", color: "#64748b" }}>{viewBill.bill_number}</p>
                </div>
                <button
