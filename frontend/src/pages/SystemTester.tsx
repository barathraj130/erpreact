...
const ALL_TESTS: TestCase[] = [
  ...
  { id: "balance-sheet", name: "Balance Sheet", category: "Finance", method: "GET", path: "/reports/finance/balance-sheet", expectStatus: 200 },
  ...
  { id: "chit-funds", name: "Chit Funds", category: "Finance", method: "GET", path: "/chit-fund/groups", expectStatus: 200 },
  // Employees
