            ...
            >
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "20px" }}>
                ...
                <div style={{ textAlign: "right" }}>
                  ...
                  <div style={{ fontSize: "18px", fontWeight: 800, color: "#2563eb" }}>{broker.default_rate}%</div>
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "16px", marginBottom: "24px", padding: "16px", background: "#f8fafc", borderRadius: "16px" }}>
                ...
                <div>
                  ...
                  <div style={{ fontSize: "15px", fontWeight: 700, color: "#e11d48" }}>{fmt(broker.total_earned - broker.total_paid)}</div>
                </div>
              </div>
