                ...
                <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{ scale: 0.95, opacity: 0 }} style={{ background: "white", width: "100%", maxWidth: "700px", borderRadius: "24px", overflow: "hidden", boxShadow: "0 25px 50px -12px rgba(0,0,0,0.25)" }}>
                    <div style={{ padding: "25px 30px", borderBottom: "1px solid #f1f5f9", display: "flex", justifyContent: "space-between", alignItems: "flex-start", background: "#f8fafc" }}>
                        ...
                        <div style={{ display: "flex", gap: "10px" }}>
                            <button style={{ background: "white", border: "1px solid #e2e8f0", padding: "8px 12px", borderRadius: "8px", color: "#475569", fontWeight: 700, cursor: "pointer", display: "flex", alignItems: "center", gap: "6px" }}>
                                <FaEdit /> Edit
                            </button>
                    ...
                    <div style={{ padding: "30px", display: "flex", flexDirection: "column", gap: "30px" }}>
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "30px" }}>
                            ...
                            <div>
                                ...
                                <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", color: "#1e293b", fontSize: "0.95rem" }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: "10px" }}>
                            <button style={{ padding: "12px", background: "white", border: "1px solid #e2e8f0", borderRadius: "10px", fontWeight: 700, color: "#475569", cursor: "pointer", display: "flex", flexDirection: "column", alignItems: "center", gap: "5px" }}>
