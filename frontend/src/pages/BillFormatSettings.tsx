      ...
      <div style={{ maxWidth: "1000px", margin: "0 auto" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 400px", gap: "30px" }}>
          ...
          <div style={{ background: "#fff", borderRadius: "20px", padding: "40px", border: "1px solid #e2e8f0", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.05)" }}>
            ...
            <div style={{ marginBottom: "30px" }}>
              <h3 style={{ margin: "0 0 20px", fontSize: "1.1rem", borderBottom: "1px solid #f1f5f9", paddingBottom: "10px" }}>Invoice Display Toggles</h3>
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "15px" }}>
                {[
                  ...
                  <label key={item.key} style={{ display: "flex", alignItems: "center", gap: "12px", padding: "12px", background: "#f8fafc", borderRadius: "10px", cursor: "pointer" }}>
                    <input 
                      type="checkbox" 
            ...
            <div style={{ marginBottom: "30px" }}>
              <h3 style={{ margin: "0 0 20px", fontSize: "1.1rem", borderBottom: "1px solid #f1f5f9", paddingBottom: "10px" }}>Paper & Layout</h3>
              <div className="form-group" style={{ marginBottom: "20px" }}>
                <label>Paper Size</label>
                <select value={settings.paper_size} onChange={e => setSettings({...settings, paper_size: e.target.value})}>
              ...
              <div className="form-group">
                ...
                <input value={settings.footer_message} onChange={e => setSettings({...settings, footer_message: e.target.value})} />
              </div>
            </div>
