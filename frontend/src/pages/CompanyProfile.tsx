  ...
  const [bankAccounts, setBankAccounts] = useState<any[]>([
    {
      ...
      account_number: "106105501618",
      ifsc_code: "ICIC0001061",
    ...
    >
      ...
      >
        <div>
          ...
          >
            Company <span style={{ color: "var(--primary)" }}>Profile</span>
          </h1>
          <p style={{ color: "var(--text-secondary)", fontWeight: 600 }}>
            Manage company details, GSTIN, and bank accounts.
          </p>
        </div>
      </header>
          ...
          >
            ...
            >
              ...
              <div className="input-block">
                ...
                <input
                  className="input-modern"
                  value={profile.admin_name || "MASTER ADMIN"}
                />
              </div>
            </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
            ...
            >
              {bankAccounts.map((acc, idx) => (
                ...
                >
                  ...
                  >
                    <span style={{ fontWeight: 600 }}>{acc.bank_name}</span>
                    {acc.is_default ? (
                      <span
                        style={{
                          fontSize: "0.65rem",
          ...
          >
            ...
            <p style={{ fontSize: "0.85rem", opacity: 0.7, marginTop: "8px" }}>
              All modules unlocked. Next renewal: March 2024.
            </p>
          </motion.div>
        </div>
      </div>
