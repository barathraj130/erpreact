    ...
    <div style={{ padding: "0 0 40px 0" }}>
      ...
      >
        <div style={{ flex: "1 1 300px" }}>
          ...
          <p
            style={{ color: "#64748b", fontSize: "1.1rem", marginTop: " 4px" }}
          >
      ...
      >
        ...
        <div style={cardStyle}>
          ...
          <h3 style={statValueStyle}>
            ₹
            {Number(stats?.latestMetrics?.throughput || 0).toLocaleString(
              "en-IN",
            )}
          </h3>
        </div>
        ...
        <div style={cardStyle}>
          ...
          <h3 style={statValueStyle}>
            {stats?.latestMetrics?.return_on_investment || 0}%
          </h3>
          <div
            style={{
              ...badgeStyle,
...
const METHODOLOGY_STEPS = [
  {
    name: "IDENTIFY",
    desc: "Find the resource that limits the system from achieving its goal.",
    color: "#ef4444",
  },
  {
    name: "EXPLOIT",
    desc: "Ensure the constraint is never idle and only works on quality parts.",
    color: "#f59e0b",
  },
  {
    name: "SUBORDINATE",
    desc: "Align all non-constraints to the pace of the bottleneck.",
    color: "#3b82f6",
  },
  {
    name: "ELEVATE",
    desc: "Invest in increasing the capacity of the constraint.",
    color: "#a855f7",
  },
  {
    name: "PREVENT INERTIA",
    desc: "Once the constraint is broken, go back to step 1.",
    color: "#10b981",
  },
];
