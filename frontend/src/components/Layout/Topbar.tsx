...
const Topbar: React.FC<TopbarProps> = ({ mode }) => {
  ...
  // Previously this component returned null whenever there was nothing to show for
  // the branch selector, which meant no header rendered at all for most users. It now
  // always renders so the new global-search / notifications / theme toolbar is visible;
  // the branch selector itself keeps its exact original markup and behavior below.
  return (
