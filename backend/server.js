...
import salesReturnInspectionsRoutes from "./routes/salesReturnInspections.js";
...
import documentDraftsRoutes from "./routes/documentDrafts.js";
...
app.use("/api/branch-access", branchAccessRoutes);
...
app.use("/api/sales-return-inspections", salesReturnInspectionsRoutes);
